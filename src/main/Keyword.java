...
public class Keyword {
	...
	public Liquor_Category_List [] = {"소주", "맥주", "막걸리", "술&밥"}
	public Situation_Category_List [] = {"회식", "데이트", "과팅(소개팅)", "간단한 식사", "가성비", "비오는날"}
	public Fastfood_Category_List [] = {"치킨", "햄버거", "피자"}
	public Theme_Category_List [] = {"국밥", "한식", "중식", "양식", "밀면", "분식"}
